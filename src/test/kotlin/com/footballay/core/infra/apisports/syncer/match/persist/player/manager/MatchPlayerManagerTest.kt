...
import com.footballay.core.infra.apisports.syncer.match.context.MatchPlayerKeyGenerator.generateMatchPlayerKey as createMpKey
...
class MatchPlayerManagerTest {
    ...
    fun testCreateNewMatchPlayer() {
        ...
        val createdPlayer = entityBundle.allMatchPlayers.first()
    ...
    fun testUpdateExistingMatchPlayer() {
        ...
        val entityBundle = MatchEntityBundle.createEmpty().apply {
            this.homeTeam = homeTeam
            this.allMatchPlayers = listOf(existingPlayer)
        }
        ...
        assertThat(entityBundle.allMatchPlayers).hasSize(1)
        val updatedPlayer = entityBundle.allMatchPlayers.first()
    ...
    fun testUpdateMatchPlayerWithLineupInfo() {
        ...
        assertThat(entityBundle.allMatchPlayers).hasSize(1)
        val savedPlayer = entityBundle.allMatchPlayers.first()
    ...
    fun testPlayerApiSportsConnectionSuccess() {
        ...
        assertThat(entityBundle.allMatchPlayers).hasSize(1)
        val connectedPlayer = entityBundle.allMatchPlayers.first()
    ...
    fun testComplexScenarioIntegration() {
        ...
        val entityBundle = MatchEntityBundle.createEmpty().apply {
            this.homeTeam = homeTeam
            this.allMatchPlayers = existingPlayers
        }
    ...
    fun testNameBasedKeyGeneration() {
        ...
        whenever(matchPlayerRepository.saveAll(any<List<ApiSportsMatchPlayer>>())).thenReturn(listOf(savedPlayer))
    ...
    fun testEntityBundlePersistenceReflection() {
        ...
        assertThat(entityBundle.allMatchPlayers).hasSize(1)
        assertThat(entityBundle.allMatchPlayers).contains(savedPlayer)
    }
