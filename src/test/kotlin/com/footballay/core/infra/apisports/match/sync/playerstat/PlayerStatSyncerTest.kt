...
import com.footballay.core.infra.apisports.match.sync.playerstat.PlayerStatSyncer
...
class PlayerStatSyncerTest {
    ...
    private lateinit var playerStatSyncer: PlayerStatSyncer
    private lateinit var context: MatchPlayerContext

    @BeforeEach
    fun setUp() {
        MockitoAnnotations.openMocks(this)
        playerStatSyncer = PlayerStatSyncer()
    ...
    fun `팀 ID가 null인 경우 처리`() {
        // given
        val dto = createFullMatchSyncDto(
            homeTeamId = null,
            awayTeamId = 2L
        )
    ...
    fun `선수 이름이 null인 경우 스킵`() {
        // given
        val homePlayerStats = createPlayerStatisticsDto(
            teamId = 1L,
            players = listOf(
    ...
    fun `라인업에 있는 선수 매칭 성공`() {
        ...
        context.lineupMpDtoMap[mpKey] = MatchPlayerDto(
            apiId = playerId,
            name = playerName,
            number = 10,
            position = "F",
    ...
    fun `홈팀과 원정팀 선수 분리 처리`() {
        ...
        val awayPlayerStats = createPlayerStatisticsDto(
            teamId = 2L,
            players = listOf(
                createPlayerDetailDto(
                    playerId = 200L,
    ...
    private fun createFullMatchSyncDto(
        ...
        return FullMatchSyncDto(
            fixture = FullMatchSyncDto.FixtureDto(
                id = 1L,
            ...
            league = FullMatchSyncDto.LeagueDto(
                id = 1L,
                name = "Test League",
    ...
    private fun createPlayerStatisticsDto(
        ...
        return FullMatchSyncDto.PlayerStatisticsDto(
    ...
    private fun createPlayerDetailDto(
        ...
        return FullMatchSyncDto.PlayerStatisticsDto.PlayerDetailDto(
    ...
    private fun createValidStatistics(): FullMatchSyncDto.PlayerStatisticsDto.PlayerDetailDto.StatDetailDto {
        return FullMatchSyncDto.PlayerStatisticsDto.PlayerDetailDto.StatDetailDto(
            games = FullMatchSyncDto.PlayerStatisticsDto.PlayerDetailDto.StatDetailDto.GameStatsDto(
                minutes = 90,
                number = 10,
                position = "F",
                rating = "7.5",
            ...
            offsides = 2,
            shots = FullMatchSyncDto.PlayerStatisticsDto.PlayerDetailDto.StatDetailDto.ShotStatsDto(5, 3),
            goals = FullMatchSyncDto.PlayerStatisticsDto.PlayerDetailDto.StatDetailDto.GoalStatsDto(1, 0, 1, 0),
            passes = FullMatchSyncDto.PlayerStatisticsDto.PlayerDetailDto.StatDetailDto.PassStatsDto(50, 3, "85"),
            tackles = FullMatchSyncDto.PlayerStatisticsDto.PlayerDetailDto.StatDetailDto.TackleStatsDto(2, 1, 1),
            duels = FullMatchSyncDto.PlayerStatisticsDto.PlayerDetailDto.StatDetailDto.DuelStatsDto(10, 6),
            dribbles = FullMatchSyncDto.PlayerStatisticsDto.PlayerDetailDto.StatDetailDto.DribbleStatsDto(3, 2, 1),
            fouls = FullMatchSyncDto.PlayerStatisticsDto.PlayerDetailDto.StatDetailDto.FoulStatsDto(2, 1),
            cards = FullMatchSyncDto.PlayerStatisticsDto.PlayerDetailDto.StatDetailDto.CardStatsDto(0, 0),
            penalty = FullMatchSyncDto.PlayerStatisticsDto.PlayerDetailDto.StatDetailDto.PenaltyStatsDto(0, 0, 0, 0, 0)
        )
    }

    private fun createStatisticsWithRating(rating: String?): FullMatchSyncDto.PlayerStatisticsDto.PlayerDetailDto.StatDetailDto {
        return FullMatchSyncDto.PlayerStatisticsDto.PlayerDetailDto.StatDetailDto(
            games = FullMatchSyncDto.PlayerStatisticsDto.PlayerDetailDto.StatDetailDto.GameStatsDto(
                minutes = 90,
                number = 10,
            ...
            offsides = null,
            shots = FullMatchSyncDto.PlayerStatisticsDto.PlayerDetailDto.StatDetailDto.ShotStatsDto(null, null),
            goals = FullMatchSyncDto.PlayerStatisticsDto.PlayerDetailDto.StatDetailDto.GoalStatsDto(null, null, null, null),
            passes = FullMatchSyncDto.PlayerStatisticsDto.PlayerDetailDto.StatDetailDto.PassStatsDto(null, null, null),
            tackles = null,
            duels = null,
            dribbles = null,
            fouls = null,
    ...
    private fun createStatisticsWithPassesAccuracy(accuracy: String?): FullMatchSyncDto.PlayerStatisticsDto.PlayerDetailDto.StatDetailDto {
        return FullMatchSyncDto.PlayerStatisticsDto.PlayerDetailDto.StatDetailDto(
            games = FullMatchSyncDto.PlayerStatisticsDto.PlayerDetailDto.StatDetailDto.GameStatsDto(
                minutes = 90,
                number = 10,
            ...
            shots = FullMatchSyncDto.PlayerStatisticsDto.PlayerDetailDto.StatDetailDto.ShotStatsDto(null, null),
            goals = FullMatchSyncDto.PlayerStatisticsDto.PlayerDetailDto.StatDetailDto.GoalStatsDto(null, null, null, null),
            passes = FullMatchSyncDto.PlayerStatisticsDto.PlayerDetailDto.StatDetailDto.PassStatsDto(50, 3, accuracy),
            tackles = null,
            duels = null,
            dribbles = null,
            fouls = null,
