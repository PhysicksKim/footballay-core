...
class DefaultFixtureResponseCanonicalizerTest {
    ...
    private fun event(
        ...
        extraTime = null,
        team = FixtureEventsResponse.TeamInfo(teamUid = "team-$sequence", name = "Team $sequence", koreanName = null, playerColor = null),
        player = FixtureEventsResponse.PlayerInfo(matchPlayerUid = "mp-$playerSuffix", playerUid = "player-$playerSuffix", name = "Player $playerSuffix", koreanName = null, number = null),
        assist = null,
        type = type,
        detail = "$type detail",
        comments = null,
