...
class PlayerCustomPhotoServiceTest {
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(PlayerCustomPhotoServiceTest.class);
    @Autowired
    ...
    void setData() {
        // add player
        Player player1 = Player.builder().id(PLAYER1_ID).number(7).name("Ronaldo").photoUrl("https://defaultdomain.com/players/" + PLAYER1_ID + ".jpg").koreanName("호날두").position("F").build();
        Player player2 = Player.builder().id(PLAYER2_ID).number(10).name("Messi").photoUrl("https://defaultdomain.com/players/" + PLAYER2_ID + ".jpg").koreanName("메시").position("F").build();
