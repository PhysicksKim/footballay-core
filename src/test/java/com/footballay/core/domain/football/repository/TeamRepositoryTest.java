...
class TeamRepositoryTest {
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(TeamRepositoryTest.class);
    @Autowired
    ...
    void Success_findTeamByLeague() {
        ...
        List<Team> teams = teamRepository.saveAll(List.of(ltf1.home, ltf1.away, ltf2.home, ltf2.away));
