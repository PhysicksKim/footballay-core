...
class TeamApiSportsWithCoreSyncer(
    ...
    @Transactional
    override fun saveTeamsOfLeague(leagueApiId: Long, teamDtos: List<TeamApiSportsCreateDto>): List<TeamApiSports> {
        ...
        val processedTeamApiSportsList = processTeamApiSportsEntitiesBatch(teamDtos, existingTeamApiSportsMap, leagueCore)
    ...
    @Transactional
    override fun saveTeamWithLeagueId(leagueApiId: Long, teamDto: TeamApiSportsCreateDto): TeamApiSports {
        val leagueApiSports = leagueApiSportsRepository.findLeagueApiSportsByApiId(leagueApiId)
            ?: throw IllegalArgumentException("LeagueApiSports not found for apiId: $leagueApiId")
        val leagueCore = leagueApiSports.leagueCore
            ?: throw IllegalArgumentException("LeagueCore not found for LeagueApiSports with apiId: $leagueApiId")
     ...
     */
    private fun createLeagueTeamRelationshipsBatch(leagueCore: LeagueCore, teamCoreMap: Map<Long, TeamCore>) {
    ...
    private fun prepareAllTeamApiSports(
        ...
        cases.bothNewDtos.forEach { dto ->
            ...
            if (teamCore != null) {
                val newTeamApiSports = TeamApiSports(
                    teamCore = teamCore,
                    apiId = dto.apiId,
                    name = dto.name,
                    code = dto.code,
    ...
    private fun processVenuesBatch(
        ...
        val persistedVenues = if (allVenuesToSave.isNotEmpty()) {
        ...
        // Venue와 TeamApiSports 연결
        val venueToTeamIdsMap = teamDtos
     ...
     */
    private fun saveAllTeamApiSports(allTeamApiSports: Map<Long, TeamApiSports>): List<TeamApiSports> {
        return teamApiRepository.saveAll(allTeamApiSports.values)
    }
} 