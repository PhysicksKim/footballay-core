...
data class MatchEntityBundle(
     ...
     */
    fun getPlayerStats(playerKey: String): ApiSportsMatchPlayerStatistics? {
        return allMatchPlayers[playerKey]?.statistics
    }
    ...
    fun getAllPlayerStats(): Map<String, ApiSportsMatchPlayerStatistics> {
        return allMatchPlayers.mapNotNull { (key, player) ->
     ...
     */
    fun setPlayerStats(playerKey: String, playerStats: ApiSportsMatchPlayerStatistics) {
