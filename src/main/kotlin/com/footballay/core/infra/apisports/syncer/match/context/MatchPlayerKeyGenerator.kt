...
object MatchPlayerKeyGenerator {
     ...
     */
    fun generateMatchPlayerKey(apiId: Long?, name: String): String {
     ...
     */
    fun generateKeyById(apiId: Long): String {
        return "$ID_PREFIX$apiId"
    }
     ...
     */
    fun isIdBasedKey(key: String): Boolean {
     ...
     */
    fun isNameBasedKey(key: String): Boolean {
        return key.startsWith(NAME_PREFIX)
    }
