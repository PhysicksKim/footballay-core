package com.footballay.core.infra.apisports.syncer.match.persist.event.planner
...
object MatchEventChangePlanner {
    ...
    fun planChanges(
        ...
        val matchedPairs = dtoEvents.filter { entityEvents.containsKey(it.sequence) }
            .associate { dto -> 
        ...
        log.info("Event change planning completed - Create: ${changeSet.createCount}, Update: ${changeSet.updateCount}, Delete: ${changeSet.deleteCount}")
     ...
     */
    private fun validateSequenceOrder(source: String, sequences: List<Int>) {
