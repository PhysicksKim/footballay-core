...
object PlayerStatsDtoCollector {
    ...
    fun collectFrom(
        ...
        // 홈팀 통계 데이터 처리
        val homeStats = processTeamPlayerStats(
        ...
        // 원정팀 통계 데이터 처리
        val awayStats = processTeamPlayerStats(
        ...
        log.info("Collected ${collectedStats.size} player statistics (Home: ${homeStats.size}, Away: ${awayStats.size})")
    ...
    private fun processTeamPlayerStats(
        ...
        return teamPlayerStats.mapNotNull { playerStat ->
            // MatchPlayer 키 생성
            val playerKey = MatchPlayerKeyGenerator.generateMatchPlayerKey(
