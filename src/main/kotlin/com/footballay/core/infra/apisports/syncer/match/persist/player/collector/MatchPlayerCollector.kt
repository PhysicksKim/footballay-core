package com.footballay.core.infra.apisports.syncer.match.persist.player.collector
...
object MatchPlayerDtoCollector {
    ...
    fun collectFrom(context: MatchPlayerContext): Map<String, MatchPlayerDto> {
        ...
        log.info("Collected total ${allPlayers.size} unique players - Lineup: ${context.lineupMpDtoMap.size}, Event: ${context.eventMpDtoMap.size}, Stat: ${context.statMpDtoMap.size}")
