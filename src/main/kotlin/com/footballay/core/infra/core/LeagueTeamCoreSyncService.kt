...
interface LeagueTeamCoreSyncService {
     ...
     */
    fun createLeagueTeamRelationship(leagueCore: LeagueCore, teamCore: TeamCore)
     ...
     */
    fun createLeagueTeamRelationshipsBatch(leagueCore: LeagueCore, teamCores: Collection<TeamCore>)
