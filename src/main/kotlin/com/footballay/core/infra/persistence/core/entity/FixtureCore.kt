...
data class FixtureCore(
    ...
    override fun toString(): String =
        this::class.simpleName +
            "(  id = $id   ,   uid = $uid   ,   kickoff = $kickoff   ,   timestamp = $timestamp   ,   status = $status   ,   statusShort = $statusShort   ,   elapsedMin = $elapsedMin   ,   goalsHome = $goalsHome   ,   goalsAway = $goalsAway   ,   finished = $finished   ,   available = $available   ,   autoGenerated = $autoGenerated )"
}
