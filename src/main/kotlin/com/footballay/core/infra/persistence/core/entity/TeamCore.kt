...
data class TeamCore(
    ...
    fun getLeagues(): Set<LeagueCore> = leagueTeams.mapNotNull { it.league }.toSet()

    override fun toString(): String = "TeamCore(id=$id, uid=$uid, name=$name, code=$code, teamApiSportsId=${teamApiSports?.id})"
}
