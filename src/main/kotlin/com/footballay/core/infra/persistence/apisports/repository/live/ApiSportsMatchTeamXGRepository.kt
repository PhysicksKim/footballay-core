...
interface ApiSportsMatchTeamXGRepository : JpaRepository<ApiSportsMatchTeamXG, Long> {
    ...
    """)
    fun findByTeamStatisticsIdOrderByElapsedTime(@Param("teamStatisticsId") teamStatisticsId: Long): List<ApiSportsMatchTeamXG>
    ...
    @Query("""
        ...
        LIMIT 1
    """)
    fun findLatestByTeamStatisticsId(@Param("teamStatisticsId") teamStatisticsId: Long): ApiSportsMatchTeamXG?

    /**
     * 특정 팀 통계의 특정 elapsed time의 xG 기록 조회
     */
    fun findByMatchTeamStatisticsIdAndElapsedTime(teamStatisticsId: Long, elapsedTime: Int): ApiSportsMatchTeamXG?
} 