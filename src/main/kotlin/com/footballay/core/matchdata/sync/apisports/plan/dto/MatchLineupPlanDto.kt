...
data class MatchLineupPlanDto(
    ...
    data class Lineup(
        ...
        /**
         * 해당 팀의 [com.footballay.core.matchdata.sync.apisports.plan.context.MatchPlayerKeyGenerator] 에서 생성한 MatchPlayer 키 목록입니다.
         * [com.footballay.core.matchdata.sync.apisports.plan.context.MatchPlayerContext] 에서 실질적으로 값을 담은 DTO 또는 Entity 를 가져올 수 있습니다.
         */
