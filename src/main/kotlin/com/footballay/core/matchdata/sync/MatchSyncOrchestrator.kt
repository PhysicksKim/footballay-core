package com.footballay.core.matchdata.sync
 ...
 * - [com.footballay.core.matchdata.sync.dispatcher.MatchDataSyncResult] 는
 *
 * **결과 반환 유의사항**
 * [MatchSyncOrchestrator] 는 동기화 작업 후 반드시 [com.footballay.core.matchdata.sync.dispatcher.MatchDataSyncResult] 를 반환해야 합니다.
 * [com.footballay.core.matchdata.sync.dispatcher.MatchDataSyncResult] 는 다양한 호출자가 다음 동작(추가 폴링 or 종료)을 결정하는 데 사용됩니다.
 ...
 *
 * @see com.footballay.core.matchdata.sync.dispatcher.MatchDataSyncResult
 */
