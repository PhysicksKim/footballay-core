...
public class FootballDomainDtoMapper {
    ...
    private static MatchStatisticsDto createMatchStatisticsDTO(
            MatchStatisticsDto.MatchStatsFixture matchStatsFixture,
            MatchStatisticsDto.MatchStatsLiveStatus matchStatsLiveStatus,
            MatchStatisticsDto.MatchStatsTeam homeDTO,
            MatchStatisticsDto.MatchStatsTeam awayDTO,
            MatchStatisticsDto.MatchStatsTeamStatistics homeStatisticsDTO,
            MatchStatisticsDto.MatchStatsTeamStatistics awayStatisticsDTO,
            List<MatchStatisticsDto.MatchStatsPlayers> homePlayerStatisticsDTO,
            List<MatchStatisticsDto.MatchStatsPlayers> awayPlayerStatisticsDTO
    ) {
        return new MatchStatisticsDto(
                matchStatsFixture,
                matchStatsLiveStatus,
                homeDTO,
                awayDTO,
                homeStatisticsDTO,
                awayStatisticsDTO,
    ...
    private static MatchStatisticsDto.MatchStatsFixture createFixtureDTO(Fixture fixture) {
        return new MatchStatisticsDto.MatchStatsFixture(
    ...
    private static MatchStatisticsDto.MatchStatsLiveStatus createLiveStatusDTO(LiveStatus liveStatus) {
        return new MatchStatisticsDto.MatchStatsLiveStatus(
    ...
    private static MatchStatisticsDto.MatchStatsTeam createTeamDTO(Team away) {
        return new MatchStatisticsDto.MatchStatsTeam(
                away.getId(),
                away.getName(),
                away.getKoreanName(),
                away.getLogo()
    ...
    private static MatchStatisticsDto.MatchStatsPlayers createRegisteredPlayerStatisticsDTO(MatchPlayer mp, MatchStatisticsDto.MatchStatsPlayerStatistics stats) {
        ...
        return new MatchStatisticsDto.MatchStatsPlayers(
                player.getId(),
                player.getName(),
    ...
    private static MatchStatisticsDto.MatchStatsPlayerStatistics createPlayerStatisticsDto(PlayerStatistics ps) {
        return new MatchStatisticsDto.MatchStatsPlayerStatistics(
                ps.getMinutesPlayed(),
                ps.getPosition(),
                ps.getRating(),
                ps.getCaptain(),
    ...
    private static MatchStatisticsDto.MatchStatsTeamStatistics createTeamStatisticsDTO(@Nullable TeamStatistics homeStats) {
        ...
        if (homeStats == null) {
            return new MatchStatisticsDto.MatchStatsTeamStatistics(
    ...
    private static FixtureInfoDto createFixtureInfoDto(Fixture fixture) {
        return new FixtureInfoDto(
                ...
                fixture.getTimestamp(),
                fixture.isAvailable(),
                liveStatusDtoFromEntity(fixture.getLiveStatus()),
    ...
    private static LineupDto.LineupTeamDto createLineupTeamDto(Team team) {
        return new LineupDto.LineupTeamDto(
                team.getId(),
                team.getName(),
                team.getKoreanName(),
                team.getLogo()
    ...
    private static LineupDto.LineupPlayer createLineupPlayerDto(MatchPlayer matchPlayer) {
        if (isUnregisteredPlayer(matchPlayer)) {
            return new LineupDto.LineupPlayer(
                    ...
                    null,
                    matchPlayer.getTemporaryId(),
                    matchPlayer.getUnregisteredPlayerName(),
                    matchPlayer.getUnregisteredPlayerNumber(),
                    matchPlayer.getGrid(),
                    matchPlayer.getSubstitute()
            );
        } else {
            ...
            return new LineupDto.LineupPlayer(
                    ...
                    matchPlayer.getPlayer().getKoreanName(),
                    matchPlayer.getPlayer().getPhotoUrl(),
                    matchPlayer.getPosition(),
                    matchPlayer.getPlayer().getNumber(),
                    null,
                    null,
                    null,
                    matchPlayer.getGrid(),
    ...
    private static FixtureEventWithPlayerDto createFixtureEventDto(FixtureEvent fixtureEvent) {
        return new FixtureEventWithPlayerDto(
                ...
                fixtureEvent.getTimeElapsed(),
                fixtureEvent.getExtraTime(),
                createEventTeamDto(fixtureEvent.getTeam()),
                createEventPlayerDto(fixtureEvent.getPlayer()),
                createEventPlayerDto(fixtureEvent.getAssist()),
                fixtureEvent.getType().toString(),
                fixtureEvent.getDetail(),
                fixtureEvent.getComments()
        );
    }
    ...
    private static FixtureEventWithPlayerDto.EventPlayerDto createEventPlayerDto(@Nullable MatchPlayer player) {
        ...
        if (isUnregisteredPlayer(player)) {
            return new FixtureEventWithPlayerDto.EventPlayerDto(
                    ...
                    "",
                    player.getUnregisteredPlayerNumber(),
                    player.getTemporaryId() != null ? player.getTemporaryId().toString() : null
            );
        } else {
            ...
            return new FixtureEventWithPlayerDto.EventPlayerDto(
                    ...
                    player.getPlayer().getKoreanName(),
                    player.getPlayer().getNumber(),
                    null
            );
        }
    }
    ...
    private static FixtureEventWithPlayerDto.EventTeamDto createEventTeamDto(Team team) {
        return new FixtureEventWithPlayerDto.EventTeamDto(
                team.getId(),
                team.getName(),
                team.getKoreanName()
        );
