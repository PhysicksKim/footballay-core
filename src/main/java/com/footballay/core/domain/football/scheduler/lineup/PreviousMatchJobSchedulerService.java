...
public class PreviousMatchJobSchedulerService {
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(PreviousMatchJobSchedulerService.class);
    ...
    public void addJob(Long fixtureId, ZonedDateTime lineupAnnounceTime) throws SchedulerException {
        ...
        JobDetail jobDetail = JobBuilder.newJob(PreviousMatchJob.class).withIdentity(jobName, groupName).usingJobData("fixtureId", fixtureId).build();
    ...
    public PreviousMatchJobSchedulerService(final Scheduler scheduler) {
