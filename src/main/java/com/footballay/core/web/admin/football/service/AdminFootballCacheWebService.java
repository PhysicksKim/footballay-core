...
public class AdminFootballCacheWebService {
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(AdminFootballCacheWebService.class);
    ...
    public AdminFootballCacheWebService(final FootballRoot footballRoot, final ApiCommonResponseService apiCommonResponseService) {
